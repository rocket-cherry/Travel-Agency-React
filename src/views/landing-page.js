    ...
    <div className="landing-page-container1">
      ...
      <div className="landing-page-top-container">
        <nav data-role="Header" className="landing-page-navbar">
          <h1>Chaitanya Garg</h1>
          <div className="landing-page-right-side1">
            <div className="landing-page-links-container1">
              <span className="landing-page-text10">Home</span>
              <span className="landing-page-text11">About</span>
              <span className="landing-page-text12">Tour Packages</span>
              <span className="landing-page-text13">Contact</span>
            </div>
        ...
        <div className="landing-page-hero">
          <div className="landing-page-content-container">
            <h1 className="landing-page-text19 Heading">Book an exclusive</h1>
      ...
      <div id="main-section" className="landing-page-main">
        ...
        <span className="landing-page-text25">Recommended</span>
      ...
      <Hero1
        action1={
          <Fragment>
            <span className="landing-page-text27">Browse Properties</span>
          </Fragment>
        }
        action2={
          <Fragment>
            <span className="landing-page-text28">Secondary action</span>
          </Fragment>
        }
        content1={
          <Fragment>
            <span className="landing-page-text29">
              ...
              personalized tour packages for the ultimate travel experience.
            </span>
          </Fragment>
        }
        heading1={
